    ...
    <div className="max-w-[1100px] 2xl:w-[100%] xl:w-[100%] lg:w-[100%] md:w-[100%] sm:w-[90%] w-[90%] space-y-[30px] mx-auto py-[130px] pb-[50px]">
      <div className="space-y-[30px]">
        ...
        <table className="w-full mt-4 border-collapse border border-gray-300">
          <thead>
            <tr className="">
              <th className="border p-2 py-[20px] text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] text-start">Nature</th>
              <th className="border p-2 py-[20px] text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] text-start">Type</th>
              <th className="border p-2 py-[20px] text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] text-start">Description</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="border p-2 py-[20px] text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400]">
                One-off costs
              </td>
              <td className="border p-2 py-[20px] text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400]">
                Spread
        ...
        <div>
          <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[600]">
        ...
        <table className="w-full mt-4 border-collapse border border-gray-300">
          <thead>
            <tr className="">
              <th className="border p-2 py-[20px] text-start text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400]">
                Nature
              </th>
              <th className="border p-2 py-[20px] text-start text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400]">
                Type
        ...
        <div className="space-y-[20px]">
          ...
          <div className="space-y-[10px]">
            ...
            <p className="pl-5 text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] flex">
        ...
        <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] flex">
...
account is not considered to be account activity
            ...
            <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] flex">The administration fee shall be deducted from the Client’s account on the 90th calendar day of
...
charged again.
            ...
            <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] flex">The Company strives to ensure and keep correspondence with each respective Client and will
inform the Client by email that their account will be treated as a Dormant Account.

            </p>
            <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] flex">If the Client account does not have the necessary funds for the administration fee, the Company
reserves the right to charge a lower amount to cover administrative expenses and close the
account completely.
            </p>
            <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] flex">All the amounts of the fees and other expenses are stated without any taxes and charges that
          ...
          <div className="space-y-[10px]">
            ...
            <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] flex">The Company shall be entitled to charge the client an administrative fee of 20 USD (“twenty
...
reached the age of maturity in the country, which the client is a citizen of or resides in
            ...
            <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] flex">In case the remaining balance is less than 20 USD (“twenty dollars”), the Company shall reserve
...
using fraudulent means).
            ...
            <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400] flex">The administrative fee, among others, represents an approximate and reasonable cost of the
