...
function Herosection() {
  ...
  return (
    <div className="pt-[90px] pb-[10px] bg-[#FFF]">
        ...
        <div className="">
          <div className="space-y-[14px] ">
            ...
            <p className="text-[14px] max-w-[840px] w-[100%] mx-auto font-[400] leading-[150%] text-center text-[#000] tracking-[-0.32px] ">
              ...
              Elevate your trading game with state-of-the-art <br /> analysis tools and
          ...
          >
            <button className="text-white bg-[#E5AE00] px-[12px] hover:text-black hover:bg-transparent text-[18px] font-[800] border border-[#E5AE00] hover:border-[#000] rounded-[8px] max-w-[210px] w-[100%] h-[44px]">
              Start Trading Now
            </button>
            <button className="hover:text-white hover:bg-[#E5AE00] px-[12px] text-black bg-transparent text-[18px] font-[500] border hover:border-[#E5AE00] border-[#000] rounded-[8px] max-w-[210px] w-[100%] h-[44px]">
              Free Demo Account
            </button>
          </div>
