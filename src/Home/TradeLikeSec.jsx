...
function TradeLikeSec() {
  return (
    <div className="pt-[98px] space-y-[35px] pb-[92px] bg-white">
          ...
          <div className="max-w-[600px] space-y-[16px] w-[100%]">
            ...
            >
              ...
              <div className="w-[99px] h-[47px] rounded-[100px] flex items-center justify-center border border-[#9D9D9D] bg-[#fff]">
                <h3 className="text-[25px] font-[600] text-center text-[#E5AE00]">
                  21
                </h3>
              </div>
            </div>
            ...
            >
              <div className="flex items-center space-x-8">
                ...
                <h4 className="text-[25px] font-[600] text-[#181A20]">Trend</h4>
              </div>
              <div className="w-[99px] h-[47px] rounded-[100px] flex items-center justify-center border border-[#9D9D9D] bg-[#fff]">
                <h3 className="text-[25px] font-[600] text-center text-[#E5AE00]">
                  10
