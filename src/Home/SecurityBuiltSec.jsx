      ...
      <div className="max-w-[985px] space-y-[90px] w-[100%] mx-auto ">
        ...
        >
          <div className="w-[179px] flex flex-col mx-auto space-y-[1rem] justyfy-center items-center w-[100%]">
            ...
            <h4 className="text-[20px] font-[600] tracking-[-0.32px] text-center">{t('securityBuilt.feature1')}</h4>
          </div>
          <div className="w-[179px] flex flex-col mx-auto space-y-[1rem] justyfy-center items-center w-[100%]">
            <img src={cardicon2} alt="" />
            <h4 className="text-[20px] font-[600] tracking-[-0.32px] text-center">{t('securityBuilt.feature2')}</h4>
          </div>
          <div className="w-[189px] flex flex-col mx-auto space-y-[1rem] justyfy-center items-center w-[100%]">
            <img src={cardicon3} alt="" />
            <h4 className="text-[20px] font-[600] tracking-[-0.32px] text-center">{t('securityBuilt.feature3')}</h4>
          </div>
          <div className="w-[179px] flex flex-col mx-auto space-y-[1rem] justyfy-center items-center w-[100%]">
            <img src={cardicon4} alt="" />
            <h4 className="text-[20px] font-[600] tracking-[-0.32px] text-center">{t('securityBuilt.feature4')}</h4>
          </div>
          <div className="w-[179px] flex flex-col mx-auto space-y-[1rem] justyfy-center items-center w-[100%]">
            <img src={cardicon5} alt="" />
            <h4 className="text-[20px] font-[600] tracking-[-0.32px] text-center">{t('securityBuilt.feature5')}</h4>
          </div>
          <div className="w-[189px] flex flex-col mx-auto space-y-[1rem] justyfy-center items-center w-[100%]">
            <img src={cardicon6} alt="" />
            <h4 className="text-[20px] font-[600] tracking-[-0.32px] text-center">{t('securityBuilt.feature6')}</h4>
          </div>
        </div>
      </div>
    </div>
