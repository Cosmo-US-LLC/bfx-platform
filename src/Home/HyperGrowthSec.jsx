      ...
      <div className="max-w-[919px] space-y-[60px] w-[100%] mx-auto ">
        ...
        >
          <div className="flex items-center justify-between">
            <h4 className="text-[#000] font-[500] text-[26px]">{t('hyperGrowth.chartTitle')}</h4>
            <div className="flex space-x-3 items-center">
                <hr className="h-[5px] w-[20px] bg-[#E5AE00]"/>
                <p className="text-[18px] text-[#949494] font-[500]">{t('hyperGrowth.legendBlockchainFX')}</p>
            </div>
            <div className="flex space-x-3 items-center">
                <hr className="h-[5px] w-[20px] bg-[#CE2A96]"/>
                <p className="text-[18px] text-[#949494] font-[500]">{t('hyperGrowth.legendRegularPlatform')}</p>
            </div>
          </div>
          <div>
            <img src={graph} alt="" />
