        ...
        <div className="flex justify-center gap-x-4">
          <div className="bg-[#fff] max-w-[311px] rounded-[8px]  px-[17.6px] py-[37px] w-[100%] border border-[#9D9D9D]">
            <div className="space-y-[32px]">
              ...
              <p className="text-[13px] text-center leading-[187.5%] font-[400]">
                BlockchainFX can be described as a hybrid of Binance and
                Robinhood, delivering a seamless trading experience with
                exceptional speed and simplicity, powered by instant crypto
          ...
          <div className="bg-[#FBFBFB] max-w-[311px] rounded-[8px]  px-[17px] py-[32px] w-[100%] border border-[#9D9D9D]">
            <div className="space-y-[32px]">
              ...
              <p className="text-[13px] text-center leading-[187.5%] font-[400]">
                BFX is pioneering a new era of cryptocurrency by connecting
                blockchains to global markets such as Forex, Commodities, and
                ETFs. This unprecedented integration creates endless trading
          ...
          <div className="bg-[#fff] max-w-[311px] rounded-[8px]  px-[17.6px] pt-[39px] pb-[29px] w-[100%] border border-[#9D9D9D]">
            <div className="space-y-[32px]">
              ...
              <p className="text-[13px] text-center leading-[187.5%] font-[400]">
                BlockchainFX gives 560 million crypto users direct access to
                global financial markets, enabling seamless transitions across
                asset classes like Silver and BTC in seconds with advanced
                trading tools.
              </p>
            </div>
          </div>
