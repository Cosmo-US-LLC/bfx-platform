          ...
          <div className="max-w-[880px] w-[100%]">
            <div className="relative">
                <div className="absolute z-0 overflow-visible w-[364px] left-0 top-0 h-full">
                    <div className="w-[340px] h-[400px] rounded-[30px] bg-[#181a20] absolute bottom-0 right-3"></div>
                </div>
              ...
              >
                ...
                <SwiperSlide><div className="border border-red-400 py-[45px] pb-[51px] min-h-[338px] w-[353px]"></div></SwiperSlide>
              </Swiper>
            </div>
          </div>
        </div>
