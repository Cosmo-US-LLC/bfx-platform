...
function OurAwardSec() {
  return (
    <div
      id="awards"
      className="pt-[77px] space-y-[35px] bg-[#FAFAFA] pb-[80px]"
    >
      <div className="max-w-[1032.65px] relative space-y-[40px] w-[100%] mx-auto ">
        ...
        <div className="flex justify-between">
          {/* <div
            className="max-w-[486px] space-y-[10px] px-[80px] max-h-[673px] pt-[35px] rounded-[20px] w-[100%] border border-[#9D9D9D]"
            style={{
          ...
          >
            <div className="space-y-[10px] max-w-[324.48px] h-[225px] flex items-center justify-center flex-col w-[100%] relative mx-auto pb-[2.4rem]">
              <h3 className="text-[15px] text-center text-[#181A20] uppercase font-[700]">
                TheCoinRisE
              </h3>
              <p className="text-[20px] text-center leading-[115%] uppercase text-[#181A20] font-[400]">
          ...
          <img src="/desktop/award-1.png" alt="Award" className="w-[486px] h-[673px]" />
          <img src="/desktop/award-2.png" alt="Award" className="w-[486px] h-[673px]" />
          {/* <div
            className="max-w-[486px] space-y-[10px] px-[60px] max-h-[673px] pt-[35px] rounded-[20px] w-[100%] border border-[#9D9D9D]"
            style={{
              background: "rgba(241, 241, 241)",
              backdropFilter: "blur(49.51113510131836px)",
            }}
