...
function MobTopAssetsSec() {
  ...
  return (
    <div className="pt-[30px] space-y-[20px] pb-[24px] bg-[#FAFAFA] ">
      ...
      <p className="text-[15px] font-[400]  leading-[130%] text-[#181A20] tracking-[-0.32px] text-center">
        Get a chance to trade the world's most <br /> popular financial assets.
      </p>
                ...
                <div className="border pt-[26px] pb-[51px] px-[26px] border-[#9D9D9D] bg-[#fff] rounded-[8px] w-[284px] mx-auto space-y-[13px]">
                  ...
                  <div className="">
                    <h4 className="text-[#687086] pr-[3rem] pb-[10px] text-center text-[16.995px] font-[400]">
                      $0.9648&nbsp;&nbsp;{" "}
                      <span className="text-[#1DBA78]">+1.51%</span>
                    </h4>
                    <img src={graph1} className="h-[59.483px]" alt="" />
                  </div>
                  <div className="pt-2">
                    <h3 className="text-[30px] text-center font-[400] text-[#000]">
                      1:20
                    </h3>
                    <h4 className="text-[18px] text-[#000] text-center font-[400] ">
                      Leverages up to
                    </h4>
                  </div>
                </div>
              ...
              <SwiperSlide>
                <div className="border pt-[26px] pb-[51px] px-[26px] border-[#9D9D9D] bg-[#fff] rounded-[8px] w-[284px] mx-auto space-y-[13px]">
                  ...
                  <div className="">
                    <h4 className="text-[#687086] pr-[3rem] pb-[10px] text-center text-[16.995px] font-[400]">
                      $255.23&nbsp;&nbsp;{" "}
                      <span className="text-[#1DBA78]">+0.32%</span>
                    </h4>
              ...
              <SwiperSlide>
                <div className="border pt-[26px] pb-[51px] px-[26px] border-[#9D9D9D] bg-[#fff] rounded-[8px] w-[284px] mx-auto space-y-[13px]">
                  ...
                  <div className="">
                    <h4 className="text-[#687086] pr-[3rem] pb-[10px] text-center text-[16.995px] font-[400]">
                      $2,618.83&nbsp;&nbsp;{" "}
                      <span className="text-[#FF0900]">-0.49%</span>
                    </h4>
