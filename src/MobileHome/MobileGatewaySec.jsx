        ...
        >
          <div className="flex items-start space-x-[3rem] justify-center">
            <div className="flex space-y-[14px] flex-col items-center justify-start">
              ...
              <h3 className="text-[#181A20] text-center text-[20px] font-[700] leading-[105%] tracking-[-1.219] ">{t('gateway.newPlatformTitle')}</h3>
            </div>
            <div className="flex space-y-[20px] flex-col items-center justify-start">
              <img className="w-[54px] h-[54px]" src={cardicon2} alt="" />
              <h3 className="text-[#181A20] text-center text-[20px] font-[700] leading-[105%] tracking-[-1.219] ">{t('gateway.blockchainFxTitle')}</h3>
            </div>
          </div>
         <div className="space-y-[20px]">
         <div className="rounded-[16px] border border-[#C2C2C2]">
            <div className="flex justify-center py-[10px] items-center flex-col">
              ...
              <h4 className="text-[#181A20] font-[700] text-[20px] leading-[105%]">{t('gateway.costLabel')}</h4>
            </div>
            <div className="flex border-t border-[#C2C2C2]">
              <div className="w-[50%] py-[3px] border-r border-[#C2C2C2]">
                <div className="flex justify-center space-x-2 items-center">
                  <h4 className="text-[#181A20] font-[500] text-[15px] tracking-[-1px] leading-[200%]">{t('gateway.costTraditional')}</h4>
                  <img src={Iicon} alt="" />
                </div>
              </div>
              <div className="w-[50%] py-[3px]">
              <div className="flex justify-center items-center">
                  <h4 className="text-[#181A20] font-[500] text-[15px] tracking-[-1px] leading-[200%]">{t('gateway.costBfx')}</h4>
                </div>
              </div>
            </div>
          </div>
          <div className="rounded-[16px] border border-[#C2C2C2]">
            <div className="flex justify-center py-[10px] items-center flex-col">
              ...
              <h4 className="text-[#181A20] font-[700] text-[20px] leading-[105%]">{t('gateway.timeLabel')}</h4>
            </div>
            <div className="flex border-t border-[#C2C2C2]">
              <div className="w-[50%] py-[3px] border-r border-[#C2C2C2]">
                <div className="flex justify-center space-x-2 items-center">
                  <h4 className="text-[#181A20] font-[500] text-[15px] tracking-[-1px] leading-[200%]">{t('gateway.timeTraditional')}</h4>
                </div>
              </div>
              <div className="w-[50%] py-[3px]">
              <div className="flex justify-center items-center">
                  <h4 className="text-[#181A20] font-[500] text-[15px] tracking-[-1px] leading-[200%]">{t('gateway.timeBfx')}</h4>
                </div>
              </div>
            </div>
          </div>
          <div className="rounded-[16px] border border-[#C2C2C2]">
            <div className="flex justify-center py-[10px] items-center flex-col">
              ...
              <h4 className="text-[#181A20] font-[700] text-[20px] leading-[105%]">{t('gateway.teamLabel')}</h4>
            </div>
            <div className="flex border-t border-[#C2C2C2]">
              <div className="w-[50%] py-[3px] border-r border-[#C2C2C2]">
                <div className="flex justify-center space-x-2 px-[2px] py-[5px] items-center">
                  <h4 className="text-[#181A20] font-[500] text-center text-[15px] tracking-[-1px] leading-[120%]">{t('gateway.teamTraditional')}</h4>
                </div>
              </div>
              <div className="w-[50%] flex items-center justify-center py-[3px]">
              <div className="flex justify-center items-center">
                  <h4 className="text-[#181A20] font-[500] text-[15px] tracking-[-1px] leading-[200%]">{t('gateway.teamBfx')}</h4>
                </div>
              </div>
            </div>
          </div>
          <div className="rounded-[16px] border border-[#C2C2C2]">
            <div className="flex justify-center py-[10px] items-center flex-col">
              ...
              <h4 className="text-[#181A20] font-[700] text-[20px] leading-[105%]">{t('gateway.workScopeLabel')}</h4>
            </div>
            <div className="flex border-t border-[#C2C2C2]">
              <div className="w-[50%] py-[3px] border-r border-[#C2C2C2]">
                <div className="flex justify-center space-x-2 px-[2px] py-[5px] items-center">
                  <h4 className="text-[#181A20] font-[500] text-start text-[15px] tracking-[-1px] leading-[120%]">{t('gateway.workScopeTraditional')}</h4>
                </div>
              </div>
              <div className="w-[50%] flex items-center justify-center py-[3px]">
              <div className="flex justify-center items-center">
                  <h4 className="text-[#181A20] font-[500] text-[15px] tracking-[-1px] leading-[200%]">{t('gateway.workScopeBfx')}</h4>
                </div>
              </div>
            </div>
          </div>
