...
function TermsofService() {
  ...
  return (
    <div className="max-w-[1100px] mx-auto px-4 2xl:pt-[8rem] xl:pt-[8rem] lg:pt-[8rem] md:pt-[8rem] sm:pt-[6rem] pt-[6rem] pb-12 space-y-8">
    ...
    <p className="text-base md:text-lg">
      ...
      shall regulate the legal relationship between Sun Wave LLC operating the
      global brand BlockChainFX with company No. L22402 and registered at the
      The Lighthouse Trust Nevis Ltd, Suite 1, A.L. Evelyn Ltd Building, Main
      Street, Charlestown, Nevis (hereinafter referred to as the "Company"),
      and the user (a natural or legal entity) (hereinafter referred to as the
      "Client") of https://blockchainfx.io/ (hereinafter referred as the
      "Website").
    </p>
    ...
    <ol className="list-decimal pl-6 space-y-4">
      ...
      <li className="text-base md:text-lg">
        ...
        on the Website, including without limitation the Privacy Policy,
    ...
    <div className="space-y-6">
      <h2 className="text-2xl md:text-3xl font-semibold">1. Terms</h2>
      <ol className="list-decimal pl-6 space-y-4">
        <li className="text-base md:text-lg">
          Account – means a unique personified account registered in the name
          of the Client and which contains all the Client's transactions/
          operations on the Trading Platform (as defined below) of the
          Company.
        </li>
        <li className="text-base md:text-lg">
        ...
        <li className="text-base md:text-lg">
          ...
          direction of the price movement of an asset at a certain period of
          the day. The payout is pre-determined as a fixed amount whether the
          option expires in the money or if the option expires out of the
          money.
        </li>
        <li className="text-base md:text-lg">
          CFD (contract for difference) – means a tradable contract entered
          into between the Client and the Company, who exchange the difference
          in the value of an Instrument, as specified on the Trading Platform
          at the time of opening a Transaction, and the value of that
          Instrument at the contract's end.
        </li>
        <li className="text-base md:text-lg">
          Digital Option Contract – means a type of derivative instrument
          where the Client earns a payout if they correctly predict the price
          movement of the underlying asset at the time of the option's expiry.
          The prediction can be made as to whether the value of the underlying
          asset will fall above or below the strike price at the time of
          expiration. Should the option expire at the selected strike price,
          it will be considered to expire out-of-the money and will result in
          the loss of the invested amount.
        </li>
        <li className="text-base md:text-lg">
        ...
        <li className="text-base md:text-lg">
          ...
          including without limitation a copy of the passport or ID and
          utility bill of the Client, in case it is a natural person and/or
          certificates showing the management and ownership going all the way
          up to the ultimate beneficial owner, in case it is a legal entity,
          and any other documents the Company may request upon its sole
          discretion.
        </li>
        <li className="text-base md:text-lg">
          ...
          regulated or not and whether it is in the relevant jurisdiction or
          abroad.
        </li>
        <li className="text-base md:text-lg">
        ...
        <li className="text-base md:text-lg">
          ...
          limited to crediting of funds, return of funds, opening and closing
          of trade transactions/positions and/or that relate to financial
          instruments.
        </li>
        <li className="text-base md:text-lg">
          Prices – means the prices offered to the Client for each
          transaction, which may be changed without prior notice. Where this
          is relevant, the "Prices" given through the Trading Platform include
          the Spread (see definition below).
        </li>
        <li className="text-base md:text-lg">
          Services – means the services described in section 2 of this
          Agreement through the Trading Platform.
        </li>
        <li className="text-base md:text-lg">
        ...
        <li className="text-base md:text-lg">
          Introducing Broker – means any person (natural person or a legal
          entity) who wishes to refer Clients to the Company and has entered
          into an Introducing Broker Agreement and has successfully opened an
          IB Account (as defined in the Introducing Broker Agreement).
        </li>
        <li className="text-base md:text-lg">
          Serviced Countries - means any country available for registration on
          the Company's Website (e.g Thailand, Mexico, Egypt)
        </li>
      </ol>
    </div>
      ...
      <ol className="list-decimal pl-6 space-y-4">
        ...
        <li className="text-base md:text-lg">
          ...
          <ol className="list-decimal pl-6 space-y-2 mt-2">
            <li className="text-base md:text-lg">
              Investment services
              <ol className="list-[lower-roman] pl-6 space-y-2 mt-2">
                <li className="text-base md:text-lg">
            ...
            <li className="text-base md:text-lg mt-2">
              ...
              <ol className="list-[lower-roman] pl-6 space-y-2 mt-2">
                <li className="text-base md:text-lg">
                  Safekeeping and administration of the Financial Instruments
                  for the Client's Trading Account, including custodianship
                  and related services such as cash/collateral management.
                </li>
                <li className="text-base md:text-lg">
                  Granting credits or loans to one or more financial
          ...
          <p className="text-base md:text-lg mt-4">
            ...
            separate agreement. Our services include 'execution only' meaning
            that the Company will act on your instructions and will not advise
            you on any transaction, nor will we monitor your trading decisions
            to determine if they are appropriate for you or to help you avoid
            losses. You should obtain your own financial, legal, taxation and
        ...
        <li className="text-base md:text-lg">
          ...
          <ol className="list-[lower-roman] pl-6 space-y-2 mt-2">
            <li className="text-base md:text-lg">
              Option contracts (i.e. Digital Options and/or Binary Options) in
              stocks, commodities, indices and currency pairs;
            </li>
            <li className="text-base md:text-lg">
              Financial Contracts for Difference (CFDs) in stocks, currency
          ...
          <p className="text-base md:text-lg mt-4">
            ...
            voting right, title or interest in the underlying instrument of
            the Transaction. You understand that you are not entitled to take
            ...
            apply. The Company reserves the right to, at its sole discretion
            and for all CFD products, impose the following expiration times:
      ...
      <ol className="list-decimal pl-6 space-y-4">
        <li className="text-base md:text-lg">
          ...
          <ol className="list-[lower-alpha] pl-6 space-y-2 mt-2">
            <li className="text-base md:text-lg">
              Being of age of maturity in accordance with the jurisdiction
              he/she resides in or is a resident of, is of legal competence
              and of sound mind.
            </li>
            <li className="text-base md:text-lg">
              Not residing in any country where distribution or provision of
              the financial products or services offered by the Company would
              be contrary to local laws or regulations. It is the Client's
              responsibility to ascertain the terms of and comply with any
              local laws or regulations to which they are subject.
            </li>
            <li className="text-base md:text-lg">
              Not being a citizen of USA/territories of the US, North Korea,
              Palestine, Vatican and/or a resident of either the
              USA/territories of the US, Canada, Afghanistan, Australia,
              Belarus, Belgium, Bouvet Island, Comoros, Cuba, Democratic
              Republic of the Congo, Eritrea, Ethiopia, Gibraltar, Guam, Iran,
              Israel, Japan, Mali, Myanmar, North Korea, Palestine, South
              Sudan, Sudan, Syria, the Russian Federation, the United Kingdom,
        ...
        <li className="text-base md:text-lg">
          ...
          in accordance with the terms and conditions of this Agreement and on
          an execution-only basis. The Company shall not manage the Client's
        ...
        <li className="text-base md:text-lg">
          ...
          orders/transactions may result in not being beneficial for the
        ...
        <li className="text-base md:text-lg">
          ...
          shall reasonably assume that such orders are submitted by the Client
          and the Company shall not be under any obligation to investigate
          further into the matter. The Company shall not be liable to and/or
          does not maintain any legal relations with any third party other
          than the Client.
        </li>
        <li className="text-base md:text-lg">
          If the Client acts on behalf of any third party and/or on behalf of
          any third party's name, the Company shall not accept this person as
          a Client and shall not be liable before this person, regardless if
          such person was identified or not.
        </li>
        <li className="text-base md:text-lg">
        ...
        <li className="text-base md:text-lg">
          ...
          client acknowledges and agrees that the Company's live chat feature
          is not and will not constitute a valid and/or accurate information
          and/or information addressed to the clients/potential clients and/or
          in any way information that is controlled by the Company and/or
          investment advice, as it is merely a feature allowing clients to
        ...
        <li className="text-base md:text-lg">
          ...
          Company, the provision of reports, news, opinions, price movement
          alerts as displayed in the Company's trading platform and any other
    ...
    <div className="space-y-6">
      ...
      <ol className="list-decimal pl-6 space-y-4">
        <li className="text-base md:text-lg">
          ...
          understood all the provisions of this Agreement and related
          information on the Website. The Client accepts and understands that
          some orders shall be executed by the Company as the counterparty of
          the transaction in its capacity of Market Maker and shall act as a
          principal and not as an agent on the Client's behalf for the purpose
          of the Execution of orders. The Client is informed that Conflicts of
          Interest may arise because of this model. Moreover, the Client
          further accepts that the Company may transmit some orders and act as
          an intermediary for Clients' transactions. Reception of the order by
          the Company shall not constitute acceptance, and acceptance shall
        ...
        <li className="text-base md:text-lg">
          The Client acknowledges and agrees that the Company shall bear no
        ...
        <li className="text-base md:text-lg">
          The client agrees and understands the following in consideration of
          the below corporate actions:
          <ol className="list-[lower-alpha] pl-6 space-y-2 mt-2">
            <li className="text-base md:text-lg">
              Where it is publicly available that a specific Company has
            ...
            <li className="text-base md:text-lg">
              In circumstances where the underlying asset offered by the
        ...
        <li className="text-base md:text-lg">
          The Client acknowledges that the Company will have the right, at any
          time and for any reason and without justification, at its sole
          discretion, to refuse to execute orders, including, without
          limitation, in the following circumstances:
          <ol className="list-[lower-alpha] pl-6 space-y-2 mt-2">
            <li className="text-base md:text-lg">
              If the execution of the order aims or may aim to manipulate the
              market price of the financial instruments (market manipulation);
            </li>
            <li className="text-base md:text-lg">
              If the execution of the order constitutes or may constitute
              abusive exploitation of confidential information (insider
              trading);
            </li>
            <li className="text-base md:text-lg">
              If the execution of the order contributes or may contribute to
              the legalization of the proceeds of illegal activities (money
              laundering);
            </li>
            <li className="text-base md:text-lg">
              If the Client has insufficient funds to cover the purchase of
              financial instruments or if there is an insufficient number of
              financial instruments to cover their sale;
            </li>
            <li className="text-base md:text-lg">
              If the Client fails to fulfill any of his/her obligations
              towards the Company under this Agreement;
            </li>
            <li className="text-base md:text-lg">
              The Company's own exposure levels as set out in the Company's
              ...
              the Client wishes to buy/sell. In this event, the Company
              reserves the right to limit the size of trades and/or
              transactions;
            </li>
            <li className="text-base md:text-lg">
              If the Client is currently, or at any time becomes, a U.S.
              Reportable Person, a citizen of North Korea, Palestine, or
              Vatican City, or a resident of the United States, its
              territories, or any of the following countries or regions:
              Canada, Afghanistan, Australia, Belarus, Belgium, Bouvet Island,
              Comoros, Cuba, Democratic Republic of the Congo, Eritrea,
              Ethiopia, Gibraltar, Guam, Iran, Israel, Japan, Mali, Myanmar,
              North Korea, Palestine, South Sudan, Sudan, Syria, the Russian
              Federation, the United Kingdom, Ukraine, Vatican City, any
              member country of the European Economic Area (EEA), or any other
              jurisdiction deemed non-serviced.
            </li>
          </ol>
        </li>
        <li className="text-base md:text-lg">
          The Client acknowledges that, at its own discretion, under certain
          market conditions and/or depending on the availability of the
          underlying asset on the relevant market, the Company may have to
          close all or a part of the Client's positions. Including but not
          limited to positions where it has reached or surpassed internal
          exposure levels and/or where for any reason the underlying asset is
          unavailable on the relevant market. The Company undertakes to
          provide prior notification to the Client in case a position will be
          liquidated by the Company.
        </li>
        <li className="text-base md:text-lg">
          Any such refusal by the Company shall not affect any obligation,
          which the Client may have towards the Company.
        </li>
      </ol>
    </div>
    ...
    <div className="space-y-6">
      <h2 className="text-2xl md:text-3xl font-semibold">
        5. Limitation of Liability (continued)
      </h2>
      <ol className="list-decimal pl-6 space-y-4" start={1}>
        <li className="text-base md:text-lg">
        ...
        <li className="text-base md:text-lg">
          ...
          responsibility for direct or indirect damages of any kind, even if
          the Company or its Agent(s) had been notified of the possibility of
          aforesaid damages.
        </li>
        <li className="text-base md:text-lg">
          In case a Client registers an Account through an Introducing Broker,
          referring agents, or other third parties, it is hereby agreed as
          follows:
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li className="text-base md:text-lg">
              The Company shall not be responsible or liable for any agreement
              or arrangement that may exist between the Client and these
              persons, or for any additional costs that may arise as a result
              of such agreement;
            </li>
            <li className="text-base md:text-lg">
              The Introducing Broker and/or referring agents are not
              representatives or agents of the Company, and they do not act on
              behalf of the Company. In this respect, they are not authorized
              to provide any guarantees or any promises regarding the Company
              or its services nor provide advice or personal recommendations
              to the Client regarding the Client's Account and/or transactions
              and the Company shall accept no responsibility whatsoever for
              any such advice or recommendations.
            </li>
          </ul>
        </li>
      </ol>
    ...
    <div className="space-y-6">
      ...
      <ol className="list-decimal pl-6 space-y-4">
        <li className="text-base md:text-lg">
          ...
          <ol className="list-[lower-alpha] pl-6 space-y-2 mt-2">
            <li className="text-base md:text-lg">
              Submit with the Company any order requesting the execution of a
              transaction/Operation on the Website in accordance with and
              subject to the terms and conditions of this Agreement;
            </li>
            <li className="text-base md:text-lg">
              Request withdrawal of any amounts subject and in accordance with
              the Withdrawal Policy, and provided that the Company has no
              claims against the Client and/or the Client does not have any
              outstanding debts to the Company;
            </li>
            <li className="text-base md:text-lg">
              In the event that the Client has any alleged complaint against
              the Company and/or there is any dispute between the Client and
              the Company, then the Client can submit his/her complaint, to
              include all relevant particulars and details, to the Company at
              complaints@blockchainfx.io. The Company shall acknowledge
              receipt of any such complaint, initiate an internal
            ...
            <li className="text-base md:text-lg">
              Unilaterally terminate the Agreement provided that there is no
              debt outstanding from the Client to the Company and such
        ...
        <li className="text-base md:text-lg">
          ...
          <ol className="list-[lower-alpha] pl-6 space-y-2 mt-2">
            <li className="text-base md:text-lg">
              Acknowledges that the Account shall be activated upon the
              deposit of funds/advance payment into the Account.
            </li>
            <li className="text-base md:text-lg">
              Warrants that he/she shall at all times be compliant with and
              honor all terms and conditions of this Agreement.
            </li>
            <li className="text-base md:text-lg">
              Warrants that he/she shall ensure that at all times the username
              and password issued by the Company in relation to the use of the
              Service(s) and the Account, will only be used by him/her and
              will not be disclosed to any other person;
            </li>
            <li className="text-base md:text-lg">
              Shall be liable for all orders submitted through his/her
              security information, and any orders received in this manner by
              the Company shall be considered to have been given by the
              Client;
            </li>
            <li className="text-base md:text-lg">
              Hereby accepts the risk of orders placed by unauthorized persons
              and/or trading account used by someone without the client's
              permission (hereinafter collectively referred to as
              ...
              <ol className="list-[lower-roman] pl-6 space-y-2 mt-2">
                <li className="text-base md:text-lg">
                  The client shall notify the Company immediately regarding
                  unauthorized access to his/her trading account;
                </li>
                <li className="text-base md:text-lg">
                  The Company shall be entitled to block immediately the
                ...
                <li className="text-base md:text-lg">
                  The client shall provide the Company with any information
                  and/or documents deemed necessary in order to unblock the
                  trading account.
                </li>
              </ol>
            </li>
            <li className="text-base md:text-lg">
              Hereby acknowledges that frequent access and logins to the
              ...
              lead the Company to believe that section 15.4.XI has been
              breached.
            </li>
          </ol>
        </li>
    ...
    <div className="space-y-6">
      ...
      <ol className="list-decimal pl-6 space-y-4">
        ...
        <li className="text-base md:text-lg">
          ...
          which the Company has omitted to do, whenever caused, unless such
          act or omission resulted from gross negligence, willful default or
        ...
        <li className="text-base md:text-lg">
          In the event that the Company acts as an intermediary to Clients
          transactions, the Client hereby agrees and acknowledges that:
          <ol className="list-decimal pl-6 space-y-2 mt-2">
            <li className="text-base md:text-lg">
              under certain market conditions at the time of execution and/or
              depending on the risk management framework of the third-party
              market maker, the Company may have to cancel the Client's
              trade(s) and/or transaction(s) and return the relevant invested
              funds to the Client's trading account balance. The Company
              undertakes to provide adequate notification to the Client in
              such a case.
            </li>
            <li className="text-base md:text-lg">
              Should the aforementioned occur, the Client will have no right,
              claim or demand from the Company and undertakes to indemnify the
              Company for any damage caused by the Company's aforesaid action.
            </li>
          </ol>
        </li>
      </ol>
    ...
    <div className="space-y-6">
      <h2 className="text-2xl md:text-3xl font-semibold">9. Personal Data</h2>
      <ol className="list-decimal pl-6 space-y-4">
        <li className="text-base md:text-lg">
        ...
        <li className="text-base md:text-lg">
          ...
          including without limitation anti-money laundering regulations, as
          well as for any and all purposes in relation to this Agreement,
          including without limitation to enable the Company to discharge its
    ...
    <div className="space-y-6">
      <h2 className="text-2xl md:text-3xl font-semibold">10. Assignment</h2>
      <ol className="list-decimal pl-6 space-y-4">
        <li className="text-base md:text-lg">
    ...
    <div className="space-y-6">
      ...
      <ol className="list-decimal pl-6 space-y-4">
        <li className="text-base md:text-lg">
          One-Click Trading mode allows you to perform trading operations on
          the platform with only one click on the Buy/Call or Sell/Put
          buttons, without any additional confirmations.
        </li>
        <li className="text-base md:text-lg">
          Opting in for the One-Click Trading mode means that you acknowledge
          that you have read and understood the following terms and
          conditions, and you agree to be bound hereby.
        </li>
        <li className="text-base md:text-lg">
          Your current version of the platform enables you to choose between
          the following modes for order submission. You agree that you will be
          bound by the procedures and conditions specified herein with respect
          to each such mode.
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li className="text-base md:text-lg">
              There are several steps you have to follow when using the
              default mode for the submission of orders. Using the default
              mode, you first invoke the instruments menu and choose the
              assets you want to trade. Then you select all parameters
              depending on the instrument you have chosen and confirm your
              order submission by clicking either Buy/Call or Sell/Put buttons
              depending on the particular order type selected and your trading
              intentions. Using the default mode, a confirmation window will
              appear, and you will have to confirm your intentions and the
              trade details in order to confirm the transaction. Your order
              will not be submitted until you have completed the
              aforementioned procedure.
            </li>
            <li className="text-base md:text-lg">
              The One-Click Trading mode for order submission ("One-click
              trading") is a one-step process. You will be submitting orders
              when you single-click either Buy/Call or Sell/Put buttons.
            </li>
          </ul>
        </li>
        <li className="text-base md:text-lg">
          ...
          order once you click the Buy/Call or Sell/Put buttons (with the
          exemption of a 3-second cancellation period for binary options) and
          only certain parameters such as stop loss and take profit orders for
          CFDs can be modified after having opened a trade. Under normal
          market conditions and system performance, a market order will be
          promptly filled after submission, and you will have entered into a
          binding transaction.
        </li>
        <li className="text-base md:text-lg">
          You can activate or deactivate One-Click Trading mode in the
          settings of the platform. One-Click Trading can be activated or
          deactivated for one or several instruments in the settings.
        </li>
        <li className="text-base md:text-lg">
          By selecting the One-Click Trading mode, you understand that your
          orders will be submitted by clicking the Buy/Call or Sell/Put
          button, without any further order confirmation. You agree to accept
          all risks associated with the use of the order submission mode you
          have chosen, including, without limitation, the risk of errors,
          omissions or mistakes made in submitting any order.
        </li>
        <li className="text-base md:text-lg">
          ...
          such errors, omissions or mistakes by you or any other person
          trading on your behalf.
        </li>
        <li className="text-base md:text-lg">
          If you accept the One-Click Trading terms and conditions, tick the
          "buy in one click" option when opening trades on the platform. If
          you do not accept the conditions, do not tick the box and do not use
          the One-Click Trading function.
        </li>
      </ol>
    </div>
    ...
    <div className="space-y-6">
      ...
      <ol className="list-decimal pl-6 space-y-4">
        ...
        <li className="text-base md:text-lg">
          The Company may pay a fee/commission to the Introducing Broker,
          referring agents, or other third parties based on a written
    ...
    <div className="space-y-6">
      ...
      <ol className="list-decimal pl-6 space-y-4">
        <li className="text-base md:text-lg">
          ...
          pertaining to this agreement, including without limitation to
          matters of interpretation and/or disputes, shall be governed by the
          laws of Sait Kitts and Nevis.
        </li>
        <li className="text-base md:text-lg">
          The Company and the Clients irrevocably submit to the jurisdiction
          of the courts of Saint Kitts and Nevis.
        </li>
        <li className="text-base md:text-lg">
          The Company shall be entitled to use the interpreter's services
          during the court trial in case of dealing with a disputable
          situation according to the legislation of Saint Kitts and Nevis.
        </li>
      </ol>
    </div>
    ...
    <div className="space-y-6">
      ...
      <ol className="list-decimal pl-6 space-y-4">
        ...
        <li className="text-base md:text-lg">
          ...
          circumstances:
          <ol className="list-[upper-alpha] pl-6 space-y-2 mt-2">
            <li className="text-base md:text-lg">
              Each Party shall be entitled to terminate this Agreement at any
              time by giving to the other Party 15 (fifteen) days written
            ...
            <li className="text-base md:text-lg">
              ...
              <ol className="list-[lower-roman] pl-6 space-y-2 mt-2">
                ...
                <li className="text-base md:text-lg">
                  If any application is made or any order is issued, or a
                  meeting is convened, or a resolution is approved, or any
                  measures of bankruptcy or winding up of the Client are
                  taken.
                </li>
                <li className="text-base md:text-lg">
                  The Client violates, or the Company has reasonable grounds
                  to believe that the Client violated, any of the Client's
                  obligations under and/or terms of, this Agreement and/or is
                  in breach of any of the warranties and representations made
                  by her/him in this Agreement.
                </li>
                <li className="text-base md:text-lg">
                  If it comes to the Company's attention and/or the Company
                  has reasonable grounds to believe that the Client has not
                  reached the age of maturity in the country in which he is
                  resident or citizen, as applicable.
                </li>
                <li className="text-base md:text-lg">
                  If it comes to the Company's attention and/or the Company
                  ...
                  USA/territories of the US, Canada, Afghanistan, Australia,
                  Belarus, Belgium, Bouvet Island, Comoros, Cuba, Democratic
                  Republic of the Congo, Eritrea, Ethiopia, Gibraltar, Iran,
                  Israel, Japan, Mali, Myanmar, North Korea, Palestine, South
                  Sudan, Sudan, Syria, the Russian Federation, the United
                  Kingdom, Ukraine, Vatican, any country of the European
                  Economic Area and/or other non-serviced countries.
                </li>
                <li className="text-base md:text-lg">
                  The Company has suspicion based on available information
                  that the Client:
                  <ol className="list-[lower-alpha] pl-6 space-y-2 mt-2">
                    <li className="text-base md:text-lg">
                      Is and/or has been using fraudulent means or was
                      involved in a fraudulent scheme in relation to the
                      performance of this Agreement;
                    </li>
                    <li className="text-base md:text-lg">
                      Has illegally and/or improperly and/or unfairly and/or
                      otherwise gained an unfair advantage, over and/or to the
                      detriment of (i) other clients of the Company and/or
                      (ii) the Company;
                    </li>
                    <li className="text-base md:text-lg">
                      Has unjustly enriched by using information which was
                      intentionally and/or negligently and/or otherwise
                      concealed and/or not disclosed in advance by the Client
                      to the Company and/or for which the Company had known in
                    ...
                    <li className="text-base md:text-lg">
                      Has performed acts with the intention and/or effect of
                      manipulating and/or abusing the market and/or the
                      Company's trading systems and/or deceiving the Company
                      and/or defrauding the Company; and/or
                    </li>
                    <li className="text-base md:text-lg">
                      Has acted in bad faith during the performance of his
                      obligations under the Agreement.
                    </li>
                  </ol>
                </li>
                <li className="text-base md:text-lg">
                  The Client being guilty, or the Company has suspicions that
                  the Client is guilty of malicious conduct or gross
                ...
                <li className="text-base md:text-lg">
                  In case the Client receives 2 warnings regarding verbal
                  abuse against employees of the Company.
                </li>
                <li className="text-base md:text-lg">
                  If the Client fails to provide the Company with the required
                  verification documents and/or information at any time,
                  whether at the beginning of the business relationship or on
                  an ongoing basis, within the specified timeframe, as deemed
                  necessary by the Company.
                </li>
                <li className="text-base md:text-lg">
                  In case the Client uses and/or there are indications that
                  lead the Company to reasonably believe that the Client uses
                  different IP addresses from different countries and/or VPN
                  and/or VPS during the course of executing any transactions
                  and/or trades through the Trading Account and/or the
                  provision of the Services. Whether the Client has provided
                  notice to the Company for any change to its IP address
                  and/or of the use of VPN and/or VPS is irrelevant.
                </li>
                <li className="text-base md:text-lg">
                  The Client has initiated a chargeback in relation to the
                  funds held in the Client's Account. In case the Company
                ...
                <li className="text-base md:text-lg">
                  Where the Company identifies that the Client is involved
                  and/or is using a high-frequency trading software with the
                  purpose of manipulating the Company's systems and/or trading
                  platform and/or has illegally and/or improperly and/or
                  maliciously and/or knowingly gained an unfair advantage over
                  and/or to the detriment of other clients of the Company
                  and/or the Company and/or this high-frequency trading
                  software is designed to abuse the Company's systems and/or
                  trading platform.
                </li>
                <li className="text-base md:text-lg">
                  Where the Company identifies that the Client's funds and/or
                  payment account(s) have been used to fund a third-party
                  account, and it has reasonable suspicion that the Client
                  and/or third party is circumventing any of the clauses of
                  the present Agreement by doing so and/or is acting in
                  collaboration with a third party circumventing any of the
                  clauses of this Agreement.
                </li>
                <li className="text-base md:text-lg">
                  The client is and/or has been convicted of a criminal
                  offence and/or is cautioned and/or charged by the police or
                  other competent authority with a criminal offence.
                </li>
              </ol>
            </li>
          </ol>
        ...
        <li className="text-base md:text-lg">
          ...
          clause 15.4.B, of this Agreement, the Company shall have no
          liability towards the Client and no obligation to pay any of the
          profits generated by trading (if any); Furthermore, it is up to the
          Company's sole discretion to decide if any deposited funds will be
          paid to the Client.
        </li>
        <li className="text-base md:text-lg">
          In case of termination of this Agreement for a reason indicated in
          sections 15.4.A of this Agreement, the Company shall have either to
          wire to the Client the remaining balance or to give to the Client
          the opportunity to withdraw his/her remaining balance.
        </li>
      </ol>
    </div>
    ...
    <div className="space-y-6">
      ...
      <ol className="list-decimal pl-6 space-y-4">
        ...
        <li className="text-base md:text-lg">
          ...
          button, the Client shall agree that he/she cannot return the payment
          or require its recall. Additionally, by accepting the terms and
          conditions herein contained, the Client as the owner of the payment
          card confirms that he/she shall be entitled to use the Services
        ...
        <li className="text-base md:text-lg">
          ...
          3-D secure transactions, the client needs to enable the 3-D secure
        ...
        <li className="text-base md:text-lg">
          ...
          the Client to promptly refuse from making a payment and to directly
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        <ol className="list-decimal pl-6 space-y-4">
          ...
          <li className="text-base md:text-lg">
            ...
            of the Website at the Client's sole option, discretion and risk,
            and the Client is solely responsible for ascertaining whether it
            is legal in the Client's jurisdiction and/or place of residence.
            The Client holds sole liability for all transactions in his
            Trading Account, including all card transactions or other means of
      ...
      <div className="space-y-6">
        <h3 className="text-xl md:text-2xl font-semibold">2. Risks</h3>
        <ol className="list-decimal pl-6 space-y-4">
          <li className="text-base md:text-lg">
          ...
          <li className="text-base md:text-lg">
            ...
            prices fluctuate widely; as such, they entail the risk of losing
      ...
      <div className="space-y-6">
        ...
        <ol className="list-decimal pl-6 space-y-4">
          <li className="text-base md:text-lg">
            ...
            Client may incur (or to a third party) due to reliance on
        ...
        <div className="pl-6 space-y-4">
          <div className="space-y-2">
            ...
            <ol className="list-decimal pl-6 space-y-2">
              ...
              <li className="text-base md:text-lg">
                The request/order shall be sent from the Trading Platform to
                the server;
              </li>
              <li className="text-base md:text-lg">
              ...
              <li className="text-base md:text-lg">
                In case that the connection between the trading platform and
                the server is correct, the trading platform will receive the
                results of processing of the Client request or order by the
                Company.
              </li>
            </ol>
          </div>
          ...
          <div className="space-y-2">
            <p className="text-base md:text-lg font-medium">
              ...
              of the communication between the Trading Platform and the server
              of the Company, as well as on the market conditions. In normal
              market conditions, the time of the process usually varies
              between 0–4 seconds. In market conditions that differ from
              normal, the time of Client request/order processing can be
              higher than that.
            </p>
          </div>
          ...
          <div className="space-y-2">
            <p className="text-base md:text-lg font-medium">
              C. The server of the Company may refuse the Client's
              request/order in the following cases:
            </p>
            <ol className="list-decimal pl-6 space-y-2">
              <li className="text-base md:text-lg">
                If the Client sends the request before the first quote on the
                Trading Platform on the market opening.
              </li>
              <li className="text-base md:text-lg">
                If there is not enough funds in the Client's account for
                opening a new position;
              </li>
              <li className="text-base md:text-lg">
                If the Client sends the request/order before the opening of
                the trading session;
              </li>
              <li className="text-base md:text-lg">
                When market conditions differ from normal, such as there is
                significant volatility or instability in the markets, or the
                industry as a whole, preventing us from providing our services
                in an orderly manner, including any instances where we are
                unable to receive data and/or we receive incorrect data from
                our service providers.
              </li>
              <li className="text-base md:text-lg">
                When using the trading platform, it is allowed to use only one
                tab of the browser. In case of using several tabs of the
                browser, the results of trade can be corrected and/or
                canceled.
              </li>
            </ol>
          </div>
      ...
      <div className="space-y-6">
        <h3 className="text-xl md:text-2xl font-semibold">5. Quotes</h3>
        <ol className="list-decimal pl-6 space-y-4">
          <li className="text-base md:text-lg">
          ...
          <li className="text-base md:text-lg">
            Non-market quote – the price on the Trading Platform which does
            not correspond to the price on the market at this moment of time
            (hereinafter referred to as the "Non-market price").
          </li>
          <li className="text-base md:text-lg">
            In case that the Company executed the Client's request/order for
            Non-market quote, the following shall be imposed on the Company's
            duty:
            <ol className="list-[lower-alpha] pl-6 space-y-2 mt-2">
              <li className="text-base md:text-lg">
                In case of position closing – correction of the financial
              ...
              <li className="text-base md:text-lg">
                In case of position opening – the Company reserves the right
      ...
      <div className="space-y-6">
        <h3 className="text-xl md:text-2xl font-semibold">6. Copyright</h3>
        <ol className="list-decimal pl-6 space-y-4">
          <li className="text-base md:text-lg">
            BlockChainFX is a global brand, which in your jurisdiction is
            operated by Sun Wave LLC a company registered at The Lighthouse
            Trust Nevis Ltd, Suite 1, A.L. Evelyn Ltd Building, Main Street,
            Charlestown, Nevis (hereinafter "We" or "Company"). We are the
            controller and responsible for the data of the Client disclosed to
            us in order to register for a Trading Account, Demo Account and/or
            to make use of any other services offered by us through the
            website (hereinafter "Website") (this term shall at all times
            include Website's desktop and mobile versions).
          </li>
          <li className="text-base md:text-lg">
            The Company is the owner of all intellectual property rights on
            and throughout the Website as well as the material on it,
            including any copyright, database rights and trademarks. Any such
            right not belonging to the Company belongs to third parties and is
            protected by copyright laws and treaties around the world. All
            such rights are reserved.
          </li>
          <li className="text-base md:text-lg">
            All copyright, database rights, trademarks and any other
            intellectual property rights in the content of and/or throughout
            the Website, belong to the Company or a third party, including
            without limitation to licensors and vendors of the Company. The
            material and content on the Website (in whatever form it exists),
            may or may not be identified by a symbol, and they include, but
            are not limited to designs, photographs, graphics, drawings, text,
            etc. The lack of any such symbol should not be understood as
            meaning that the name, term or data is not the intellectual
            property of either the Company or any third party or any licensor
            of the Company.
          </li>
          <li className="text-base md:text-lg">
            BlockChainFX (in word or stylized forms) has been registered
            internationally.
          </li>
          <li className="text-base md:text-lg">
            The use of the word BlockChainFX and/or any trademark or
            intellectual property rights of the Company (as referred to in
            this paragraph 6.1), without the Company's express and written
            pre-approval, is strictly prohibited in all ways. Such prohibited
            acts, include but are not limited to copying, duplicating,
            presenting in public, altering, advertising, broadcasting,
            transferring, selling, or delivering trademarks or any
            intellectual property rights, in whole or in part to any third
            parties, distributing, including by publishing on the Internet, or
            making any commercial use of the trademarks/intellectual property
            rights, in whole or in part.
          </li>
          <li className="text-base md:text-lg">
            Any reference, presentation and/or use on the Website of
            trademarks and/or any intellectual property rights which are not
            owned by the Company but are owned by other third parties
            (Third-Party IP) is fair since their usage is limited to (a)
            descriptive and informative purposes and at no time as part of the
            Company's Services, and (b) the minimum necessary. Such
            Third-Party IP is on the Website only for informative purposes, to
            provide a simple description of the service/goods of the
          ...
          <li className="text-base md:text-lg">
            For the sake of clarity, it is noted that the mere description of
            the Third-Party IP is not of a commercial nature and is only a
            description without which it is impossible to uniquely identify
            them, is not an advertisement for goods and/or services of the
            third parties or the Services of the Company, and does not imply a
            comparison between the goods and/or services of any third parties
            and the Company.
          </li>
          <li className="text-base md:text-lg">
            The Company and the owners of the Third-Party IP (excluding
            official licensors, partners, vendors) are not affiliated in any
            way, and/or are not partners, or sponsors to each other, they are
            not bound by licensing, marketing, and/or any other agreements or
            mutual obligations, unless this is expressly stated on the
            Website.
          </li>
          <li className="text-base md:text-lg">
          ...
          <li className="text-base md:text-lg">
            The Client undertakes that any notice, message or any other
            material supplied by the Client shall be appropriate and shall not
            harm other persons including their proprietary rights. The Client
            shall refrain from uploading or sending any illegal and/or harmful
      ...
      <div className="space-y-6">
        ...
        <ol className="list-decimal pl-6 space-y-4">
          ...
          <li className="text-base md:text-lg">
            ...
            markets published by the Company are of a promotional/marketing
            nature only.
          </li>
          <li className="text-base md:text-lg">
          ...
          <li className="text-base md:text-lg">
            ...
            information purposes only. Any Client and/or potential client uses
      ...
      <div className="space-y-6">
        ...
        <p className="text-base md:text-lg pl-6">
          Closing of a trading position occurs at the current price at the
          trading server at the moment of closing of the trading operation.
        </p>
      </div>

      <div className="space-y-6">
        <h3 className="text-xl md:text-2xl font-semibold">10. OTC Assets</h3>
        <ol className="list-decimal pl-6 space-y-4">
          <li className="text-base md:text-lg">
            OTC Asset or "over the counter" is an asset that is traded out of
      ...
      <div className="space-y-6">
        <h3 className="text-xl md:text-2xl font-semibold">11. Fraud</h3>
        <p className="text-base md:text-lg">
          ...
          with regard to the subject matter of the Agreement, including
        ...
        <p className="text-base md:text-lg">
          ...
          prior notice and without the possibility of further money
          withdrawal, and/or entitled to unilaterally terminate the Agreement
          in the extrajudicial procedure.
        </p>
      </div>

      <div className="space-y-6">
        <h3 className="text-xl md:text-2xl font-semibold">12. Benefits</h3>
        <p className="text-base md:text-lg">
        ...
        <ol className="list-decimal pl-6 space-y-4">
          ...
          <li className="text-base md:text-lg">
            The client may submit a request to Support@blockchainfx.com to
            stop receiving such Benefits at any time.
          </li>
        </ol>
      </div>
      ...
      <div className="space-y-6">
        ...
        <ol className="list-decimal pl-6 space-y-4">
          <li className="text-base md:text-lg">
            For any conversion required to be effected from one currency to
            another for the execution of any order, the Company is entitled at
            its absolute discretion to debit the Client's Trading Account with
            the equivalent amount of the transaction in the currency in which
            the Client holds the Trading Account.
          </li>
          <li className="text-base md:text-lg">
            For the execution of payments when the currency of the trading
            account is different from the processing currency of the payment,
            the Company shall convert from one currency to another for each
            transaction, based on the exchange rate at the time of conversion
            (including the currency conversion fee specified in the General
            Fees Policy).
          </li>
          <li className="text-base md:text-lg">
            The Client acknowledges and agrees that he shall undertake all
            risks deriving from any such conversion and, in particular, the
            risk of loss which may be incurred as a result of the fluctuation
