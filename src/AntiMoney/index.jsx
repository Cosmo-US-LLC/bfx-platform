...
units, functions, and legal entities.
        ...
        <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400]">Each of the affiliates of the Company are required to comply with AML and KYC policies.
        </p>
        <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400]">All identification documents and services records shall be kept for the minimum period of time
        required by local law.
        </p>
        <p className="text-[14px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px]  font-[400]">All new employees shall receive anti-money laundering training as part of the mandatory new-hire
